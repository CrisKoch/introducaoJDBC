...
public class ContaDAO {
	...
	public void listagem() throws SQLException {
		  ...
		  while (resultado.next()) {
		    System.out.println(resultado.getString("titular") + " - " + resultado.getInt("id") + " - " + resultado.getInt("numero") + " - " + resultado.getInt("agencia") + " - " + resultado.getDouble("limite")+ " - " + resultado.getDouble("saldo"));
		  }
		  resultado.close();
		  stmt.close();
		  conexao.close();
